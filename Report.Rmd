...
subtitle: "Statistical Modeling & Real World Impact"
...
This exercise examines the Space Shuttle *Challenger*'s infamous 1986 launch using only the previous track record of the Space Shuttle Program. Specifically, counts of previous O-ring failures at various launch temperatures are modeled to predict the probability of a catastrophic failure occurring on the morning of the launch. It is found that the probability of a catastrophic failure occurring for the *Challenger* launch is XX%, over XX times higher than the original estimate. This comes from XX
